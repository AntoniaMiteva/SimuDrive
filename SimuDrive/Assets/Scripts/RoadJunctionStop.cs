...
public class RoadJunctionStop : MonoBehaviour
{
	...
	void Start()
	{
		...
		textMeshProUGUI.text = "Потеглете и преди знака СТОП, спрете.";
	...
	void Update()
	{
		...
		if(!didStop && carController.carDidntStopSign)
		{
	...
	private void ProcessSteps()
	{
		switch (currentStep)
		{
			...
			case StepState.Step2:
				...
				{
					textMeshProUGUI.text = "Уверете се, че няма други коли на кръстовището, с които може да си пречите, и потеглете направо, като си спазвате лентата.";
					didStop = true;
