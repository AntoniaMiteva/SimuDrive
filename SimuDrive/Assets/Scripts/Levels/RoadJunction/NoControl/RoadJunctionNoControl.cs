...
public class RoadJunctionNoControl : MonoBehaviour
{
	...
	public static bool carLevelStart = false;

	private bool didStop = false;

	private enum StepState { Step1, Step2, Completed }
	...
	void Start()
	{
		...
		textMeshProUGUI.text = "Намирате се на нерегулирано кръстовище, при което важи правилото на дясностоящия. Изчакайте автомобила от дясната ви страна да премине.";
	...
	private void ProcessSteps()
	{
		switch (currentStep)
		{
			case StepState.Step1:
				if (secondCar.carCubeCheck==3)
				{
					textMeshProUGUI.text = "Потеглете преди колата от лявата ви страна и продължете направо.";
			...
			case StepState.Step2:
				...
				{
					textMeshProUGUI.text = "Успешно минахте през кръстовището.";
	...
	{
		if (restartButtonAnotherCar != null)
		{
			restartButtonAnotherCar.onClick.RemoveAllListeners();
			restartButtonAnotherCar.onClick.AddListener(RestartLevel);
		}
	}
