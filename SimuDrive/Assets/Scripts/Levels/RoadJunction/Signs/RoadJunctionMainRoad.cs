...
public class RoadJunctionMainRoad : MonoBehaviour
{
	...
	void Update()
	{
		...
		if(carController.carStopSign && carController.Speed<1)
		{
	...
	private void ProcessSteps()
	{
		switch (currentStep)
		{
			case StepState.Step1:
				...
				{
					textMeshProUGUI.text = "Преминете безопасно през кръстовището без да спирате.";
